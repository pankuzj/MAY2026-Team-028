...
Task S1-F08 support (migration 0001 itself is Nitin's). This is the standard
Alembic ``env.py`` with three deliberate changes from the generated template:
...
#   rebuild the table instead. Needed because tests run on SQLite (plan §14).
_COMMON_OPTIONS = {
