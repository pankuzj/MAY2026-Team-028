...
Task S1-F03/F08 support. This file exists for exactly one reason: SQLAlchemy only
knows about a table once the module defining it has been imported. Alembic's
``--autogenerate`` diffs ``Base.metadata`` against the live database, so any model
...
# Uncomment each line as the model lands. Owners per plan section 9b:
#   S1-M01 User, Ward                              — Sagnik
#   S1-M02 Complaint, ComplaintStatusHistory       — Vishal
#   S1-M04 Worker, Vehicle, Equipment              — Nitin
#   S1-M03 Task + task_workers/task_equipment      — Nitin
#
...
# from app.models.resource import Equipment, Vehicle, Worker  # noqa: F401
# from app.models.task import Task  # noqa: F401

# --- Sprint 2 models (migration 0002) -------------------------------------
...
# from app.models.schedule import CollectionSchedule  # noqa: F401
